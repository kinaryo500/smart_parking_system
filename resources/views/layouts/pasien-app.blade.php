...
<head>
    <meta charset="UTF-8">
    <title>@yield('title', 'Smart Parking System - Pasien')</title>
...
<body>
    ...
    <div class="app-header d-flex justify-content-between align-items-center">
        <div>
            <h6 class="fw-bold mb-0">Smart Parking - Pasien</h6>
    ...
    <nav class="bottom-nav">
        ...
        <a href="{{ route('pasien.kendaraan.index') }}"
            class="{{ request()->routeIs('pasien.kendaraan.*') ? 'active' : '' }}">
            <i class="bi bi-car-front"></i><span>Kendaraan</span>
        </a>
        <a href="{{ route('pasien.profile') }}" class="{{ request()->routeIs('pasien.profile*') ? 'active' : '' }}">

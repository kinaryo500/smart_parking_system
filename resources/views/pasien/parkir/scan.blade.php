...
@section('title', 'Scan QR Parkir Pasien | Smart Parking')
        ...
        <div class="card border-0 shadow-sm p-3 rounded-4 mx-auto mt-4" style="max-width: 450px;">
            <div class="d-flex align-items-center">
                <div class="flex-grow-1">
                    <small class="text-muted d-block lh-1 mb-1">Kendaraan Terpilih (Pasien)</small>
            ...
            .then(res => {
                if (res.success) {
                    ...
                    Swal.fire({
                        icon: 'success',
                        title: 'Gate Terbuka!',
                        text: 'Akses Pasien dikonfirmasi. Silahkan masuk.',
                        timer: 2000,

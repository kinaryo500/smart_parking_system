...
@section('title', 'Profil Pasien | Smart Parking')
...
<div class="container py-4">
    ...
    <div class="text-center mb-4">
        ...
        <p class="text-muted small">Akun Pasien • Terdaftar {{ $user->created_at->translatedFormat('d F Y') }}</p>
    </div>
        ...
        <div class="col-md-6">
            ...
            <div class="card card-profile p-4 mb-4">
                <div class="d-flex align-items-center mb-3">
                    ...
                    <h6 class="fw-bold mb-0">Informasi Dasar Pasien</h6>
                </div>
                
                <form id="formProfile" action="{{ route('pasien.profile.update') }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
            ...
            <div class="card card-profile p-4 mb-5">
                ...
                <form id="formPassword" action="{{ route('pasien.profile.update-password') }}" method="POST">
                    @csrf
                    @method('PUT')

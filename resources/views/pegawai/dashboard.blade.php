...
@section('title', 'Dashboard Pegawai | Smart Parking')
    ...
    <div class="row g-2 text-center">
        @php
            $stats = [
                ...
                ['label' => 'Status Biaya', 'val' => 'GRATIS (PEGAWAI)', 'class' => 'text-primary', 'full' => true]
            ];
        @endphp
        ...
        <div class="card p-3 mb-3 shadow-sm border-0 parkir-card" 
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="text-end">
                    ...
                    <a href="{{ route('pegawai.dashboard.parkir.detail', $p->id) }}"
                ...
                <div id="modalBodyContainer" class="modal-body p-4">
                    ...
                    <div class="mt-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="tarifDisplay" class="form-control border-0 bg-light fw-bold text-primary" readonly value="0 (Pegawai Free)">
                        </div>
                    </div>
                </div>
...
<script>
    ...
    formParkir?.addEventListener('submit', function(e) {
        ...
        Swal.fire({
            title: 'Konfirmasi',
            text: "Mulai sesi parkir pegawai (Gratis)?",
            icon: 'question',
    ...
    function submitData() {
        ...
        fetch("{{ route('pegawai.parkir.store') }}", {
            method: "POST",
            body: formData,
            headers: {

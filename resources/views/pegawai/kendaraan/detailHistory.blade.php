@extends('layouts.pegawai-app') {{-- Sesuaikan dengan layout pegawai Anda --}}

@section('title', 'Detail Parkir Pegawai | Smart Parking')
...
<style>
    ...
    .material-symbols-rounded {
        font-size: 56px;
        color: var(--bs-primary); /* Menggunakan warna primary (biru) */
    }
...
<div class="container mt-4 mb-5">
    <div class="card card-detail p-4 text-center shadow-sm">
        ...
        <div class="mb-3">
            ...
            <h5 class="fw-bold mb-0">Detail Transaksi Pegawai</h5>
        ...
        <div class="row g-2 mb-4">
            ...
            <div class="col-6 col-sm-4 mx-auto">
                <div class="info-box">
                    ...
                    <div class="text-primary">Rp 0 (Free)</div>
                </div>
            </div>
        </div>
        ...
        <div class="py-2">
            ...
            <div id="biayaBox" 
                ...
                <small id="biayaLabel" class="d-block opacity-75 text-uppercase fw-bold" style="font-size:0.75rem;">
                    {{ $transaksi->status == 'aktif' ? 'Estimasi Biaya Pegawai' : 'Total Pembayaran' }}
                </small>

                <div class="fw-bold fs-2 mt-1">
                    <span id="biayaDisplay">Rp 0 (Gratis)</span>
                </div>
            </div>
        </div>

        <div class="d-grid mt-4">
            <a href="{{ route('pegawai.dashboard') }}" class="btn btn-outline-secondary fw-bold py-2 rounded-pill">
...
<script>
    ...
    function startLiveCounter() {
        ...
        function update() {
            ...
            document.getElementById('biayaDisplay').innerText = "Rp 0 (Gratis)";
        }
    ...
    async function syncStatus() {
        ...
        try {
            const res = await fetch(`/pegawai/transaksi/status/${transaksiId}`);
            if (!res.ok) return;
            ...
            if (data.status === 'selesai') {
                ...
                Swal.fire({
                    ...
                    text: 'Kendaraan pegawai telah keluar. Bebas biaya kontribusi.',

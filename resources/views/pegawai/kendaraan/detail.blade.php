...
@section('title', 'Detail Kendaraan Pegawai | Smart Parking')
...
<style>
    ...
    .material-symbols-rounded {
        font-size: 56px;
        color: var(--bs-primary); /* Diubah menjadi warna primary (biru) */
    }
...
<div class="container mt-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="text-start">
                    ...
                    <div class="text-muted small">
                        ...
                        <span class="text-primary fw-semibold"><span id="cost-{{ $i }}">Gratis</span></span>
                    </div>
                </div>
                
                <div>
                    <a href="{{ route('pegawai.kendaraan.detail-history', $p->id) }}" class="btn btn-outline-primary btn-detail">
                        Detail
                    </a>
                </div>
            </div>
        ...
        <script>
            (function() {
                ...
                function updateTime{{ $i }}() {
                    ...
                    document.getElementById('cost-{{ $i }}').innerText = "Rp 0 (Gratis)";
                }
                updateTime{{ $i }}();
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="text-start">
                    ...
                    <div class="text-muted small">
                        ...
                        @endif
                        <span class="mx-1">•</span>
                        <span class="fw-medium text-primary">Rp 0 (Gratis)</span>
                    </div>
                </div>

                <div>
                    <a href="{{ route('pegawai.kendaraan.detail-history', $t->id) }}" class="btn btn-outline-secondary btn-detail">
                        Detail
                    </a>
                </div>
            </div>
    ...
    <div class="card card-main p-3 mt-3 text-center bg-primary bg-opacity-10 border-0">
        ...
        <div class="text-primary fw-bold fs-5">
            Rp {{ number_format($totalSemua, 0, ',', '.') }} <span class="fs-6 fw-normal text-muted">(Khusus Pegawai)</span>
        </div>
    </div>

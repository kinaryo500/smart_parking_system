...
@section('title', 'Kendaraan Pegawai | Smart Parking')
...
@section('content')
    ...
    <style>
        .fab {
            ...
            height: 60px;
            border-radius: 50%;
            background: linear-gradient(135deg, #0061ff, #3b82f6); /* Diubah ke tema biru */
            color: white;
            border: none;
            display: flex;
            align-items: center;
            ...
            font-size: 22px;
            box-shadow: 0 10px 25px rgba(0, 97, 255, 0.4); /* Disesuaikan ke bayangan biru */
    ...
    <div class="container mt-4">
        ...
        <div class="text-center mb-5">
            <div class="bg-primary bg-opacity-10 d-inline-flex p-3 rounded-circle mb-3"> <i class="bi bi-car-front-fill text-primary fs-3"></i> </div>
            <h4 class="fw-bold mb-1">Kendaraan Pegawai</h4>
            <div class="mb-2">
                <span class="badge bg-primary-subtle text-primary px-3 py-2 rounded-pill small fw-semibold"> <i class="bi bi-patch-check-fill me-1"></i> Tarif: Bebas Biaya (Gratis)
                </span>
            </div>
            ...
            <div class="col-md-6">
                    ...
                    <div class="card p-3 mb-3 border-0 shadow-sm" style="border-radius: 16px;">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                <a href="{{ route('pegawai.kendaraan.detail', $k->id) }}"
                    ...
                    <div class="modal fade" id="modalEditKendaraan{{ $k->id }}" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0 shadow" style="border-radius: 20px;">
                                <form action="{{ route('pegawai.kendaraan.update', $k->id) }}" method="POST"
                                    class="form-update-kendaraan">
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-header border-0 pb-0">
                                        <h5 class="fw-bold">Edit Kendaraan Pegawai</h5>
                                    ...
                                    <div class="modal-footer border-0 pt-0">
                                        ...
                                        <button type="submit" class="btn btn-primary rounded-pill px-4">Simpan Perubahan</button> </div>
                                </form>
                            </div>
                        </div>
                    </div>
                @empty
                    <div class="alert alert-light text-center border-0 shadow-sm py-4">
                        ...
                        <span class="text-muted">Belum ada kendaraan pegawai terdaftar</span>
                    </div>
                @endforelse
            </div>
        </div>
    ...
    <div class="modal fade" id="modalTambahKendaraan" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow" style="border-radius: 20px;">
                <form action="{{ route('pegawai.kendaraan.store') }}" method="POST" id="formTambahKendaraan">
                    @csrf
                    <div class="modal-header border-0 pb-0">
                        <h5 class="fw-bold">Tambah Kendaraan Pegawai</h5>
                    ...
                    <div class="modal-footer border-0 pt-0">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-4">Simpan</button> </div>
                </form>
            </div>
        </div>
    </div>
            ...
            formsUpdate.forEach(form => {
                form.addEventListener('submit', function (e) {
                    ...
                    Swal.fire({
                        ...
                        confirmButtonColor: '#0061ff', /* Disesuaikan ke biru */
